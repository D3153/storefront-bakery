              ...
              <div class="row">
                ...
                <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                  <div class="text-center text-sm-left mb-2 mb-sm-0">
                    <h2 class="pt-sm-2 pb-1 mb-0 text-nowrap text-sm-left"><?= _("Hello")?>, <?= $data['userInfo']->username ?>!</h2>
                    <div class="text-muted"><small><i class="fa fa-check-circle"></i> <?= _("Online")?></small></div>
                  </div>
                   <div class="text-center text-sm-center">
                    <br><br><br>
                      <h5><?= _("Welcome to Pink Bakery")?></h5>
                      <h7><?= _("If you need more assistance, feel free to contact us")?>.</h7>
                  </div>
                  <div class="text-center text-sm-right">
                    <div class="text-muted"><small><?= _("Joined December 2022")?></small></div>
                  </div>
                </div>
              </div>
