        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 20px;">
            <div class="card-body p-5">
              <h2 class="text-center mb-5"><?= _("Add Product")?></h2>
                ...
                <div class="form-outline mb-4">
                  <label class="form-label"><?= _("Select Picture")?><input type="file" name="image" id="image" class="form-control form-control-lg" required /></label><img id='image_preview' src='/images/blank.jpg' style="max-width:200px;max-height:200px" id="product_image_preview" />
                </div>
               <script>
                  image.onchange = evt => {
                  ...
                  <label for="size"><?= _("Size")?>:</label>
                   <select name="size" id="size">
                    ...
                    <optgroup label="Pastries">
                      <option value="default"><?= _("Pastry")?></option>
                    </optgroup>
