        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 20px;">
            <div class="card-body p-5">
              <h2 class="text-center mb-5">THANK YOU!<img src="../images/bakery.png" width="50" height="50"></h2>
                ...
                <center><h6>Your order has been placed.</h6></center>
                  ...
                  <button type="submit" class="btn btn-warning" name="action">Continue Shopping</button>
                </div>
                  </form>
            </div>
          </div>
